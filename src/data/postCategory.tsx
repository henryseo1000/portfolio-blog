...
export const postCategoryList : postCategoryProps[] = [
    {
        ...
        path: "front-end",
        thumbnail: '/thumbnails/front-end-thumbnail.png'
    },
    {
        title: "Database",
        ...
        path: "database",
        thumbnail: '/thumbnails/database-thumbnail.png'
    },
    {
        title: "Server-Making",
        ...
        path: "server-making",
        thumbnail: '/thumbnails/server-thumbnail.png'
    },
    {
        title: "Basic-Web",
        ...
        path: "basic-web",
        thumbnail: '/thumbnails/basic-web-thumbnail.png'
    },
    {
        title: "Git",
        ...
        path: "git",
        thumbnail: '/thumbnails/git-thumbnail.png'
    },
    {
        title: "Settings",
        ...
        path: "settings",
        thumbnail: '/thumbnails/settings-thumbnail.png'
    },
    {
        title: "Atmega-128",
        icon: <Cpu width={17}/>,
